...
public class ChatRecorder
{
	...
	public static class Util
	{
		public static ChatRecorder startRecording(Player player)
		{
			...
			StoaPlugin.getInst().getServer().getPluginManager().registerEvents(recorder.getListener(), StoaPlugin.getInst());
			return recorder;
		}
	}
	...
	class ChatListener implements Listener
	{
		...
		@EventHandler(priority = EventPriority.MONITOR)
		private void onAllianceChatEvent(StoaChatEvent event)
		{
